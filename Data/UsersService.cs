...
public static class UsersService
{
    ...
    private static void SaveAll(List<User> users)
    {
        ...
        string appUsersFilePath = Util.GetAppUsersFilePath();
    ...
    public static List<User> Create(Guid userId, string username, string password, Role role)
    {
        ...
        users.Add(
            ...
            {
                Username = username,
                PasswordHash = Util.HashSecret(password),
                Role = role,
                CreatedBy = userId
            }
        );
    ...
    public static User Login(string username, string password)
    {
        ...
        bool passwordIsValid = Util.VerifyHash(password, user.PasswordHash);
    ...
    public static User ChangePassword(Guid id, string currentPassword, string newPassword)
    {
        ...
        bool passwordIsValid = Util.VerifyHash(currentPassword, user.PasswordHash);
        ...
        user.PasswordHash = Util.HashSecret(newPassword);
